...
import { deleteAdminProducts } from "../../../store/actions/adminActions";
...
export default function ProductDeleteForm({
  ...
  const deleteProductHandler=()=>{
    dispatch(deleteAdminProducts(product.id,setOpen,toast))
  }
  return (
    <>
          ...
          <div className="flex min-h-screen items-center justify-center py-12 px-4">
            ...
            >
              <div className="px-8 py-8">
                ...
                >
                 Are you sure want to delete the product {product.productName} ?
                </DialogTitle>
